              ...
              <tbody>
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                <a href="" data-toggle="modal" data-toggle="modal" data-target="#verifikasiModal" name="btn-edit" onclick="detail_konfirmasi(<?= $item['id_absen']; ?>)" class="btn btn-sm btn-edit btn-info">Verifikasi</i></a>
                                <a href="" data-toggle="modal" data-toggle="modal" data-target="#updateModal" name="btn-edit" onclick="detail_edit(<?= $item['id_absen']; ?>)" class="btn btn-sm btn-edit btn-warning">Edit</i></a>
                                <a href="" class="btn btn-sm btn-delete btn-danger" onclick="Hapus(<?= $item['id_absen']; ?>)" data-toggle="modal"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group form-material">
                            <label class="form-control-label">Nama Siswa</label>
                            <br>
                            <input type="text" class="form-control" id="edit_nama_konfirmasi" name="edit_nama_konfirmasi"
                                  data-parsley-required="true" placeholder="Masukkan Keterangan" readonly="" autocomplete="off" />
                        </div>

                        <div class="form-group form-material">
                            <label class="form-control-label">Status Absen</label>
                            <input type="text" class="form-control" id="edit_status_konfirmasi" name="edit_status_konfirmasi"
                                  data-parsley-required="true" placeholder="Masukkan Keterangan" readonly="" autocomplete="off" />
                        </div>
            ...
            $.getJSON('<?php echo base_url('Admin/Absen/data_edit'); ?>' + '/' + isi, {},
                function(json) {
                    ...
                    if (json.foto_absen != '' || json.foto_absen != null) {
                        ...
                        $("#foto_lama_konfirmasi").attr("src", "<?= base_url() . '/' ?>" + "docs/img/img_absen/noimage.jpg");
                    }
