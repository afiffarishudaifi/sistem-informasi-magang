              ...
              <tbody>
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                <a href="" data-toggle="modal" data-toggle="modal" data-target="#updateModal" name="btn-edit" onclick="detail_edit(<?= $item['id_jabatan']; ?>)" class="btn btn-sm btn-edit btn-warning">Edit</a>
