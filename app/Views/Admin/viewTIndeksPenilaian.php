...
<body class="animsition">
                                ...
                                <td>
                                    <center>
                                        <a href="" data-toggle="modal" data-toggle="modal" data-target="#updateModal"
                                            name="btn-edit" onclick="detail_edit(<?= $item['id_indeks']; ?>)"
                                            class="btn btn-sm btn-edit btn-warning">Edit</i></a>
                                        <a href="" class="btn btn-sm btn-delete btn-danger"
                                            onclick="Hapus(<?= $item['id_indeks']; ?>)" data-toggle="modal"
                                            data-target="#deleteModal" data-id="<?= $item['id_indeks']; ?>">Hapus</a>
                                    </center>
                                </td>
                            </tr>
                            <?php } ?>
    ...
    <form action="<?php echo base_url('Admin/IndeksPenilaian/add_indeks'); ?>" method="post" id="form_add"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group form-material">
                            ...
                            <input type="number" class="form-control" id="input_angka_awal" name="input_angka_awal"
                                data-parsley-required="true" placeholder="Masukkan Angka Nilai Awal"
                                autocomplete="off" />
                        </div>

                        <div class="form-group form-material">
                            <label class="form-control-label">Angka Nilai Akhir</label>
                            <input type="number" class="form-control" id="input_angka_akhir" name="input_angka_akhir"
                                data-parsley-required="true" placeholder="Masukkan Angka Nilai Akhir"
                                autocomplete="off" />
                        </div>
    ...
    <!-- Modal Edit Class-->
    <form action="<?php echo base_url('Admin/IndeksPenilaian/update_indeks'); ?>" method="post" id="form_edit"
        data-parsley-validate="true" autocomplete="off">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group form-material">
                            <label class="form-control-label">Angka Nilai Awal</label>
                            <input type="number" class="form-control" id="edit_angka_awal" name="edit_angka_awal"
                                data-parsley-required="true" placeholder="Masukkan Angka Nilai Awal"
                                autocomplete="off" />
                        </div>
                        ...
                        <div class="form-group form-material">
                            <label class="form-control-label">Angka Nilai Akhir</label>
                            <input type="number" class="form-control" id="edit_angka_akhir" name="edit_angka_akhir"
                                data-parsley-required="true" placeholder="Masukkan Angka Nilai Akhir"
                                autocomplete="off" />
                        </div>
