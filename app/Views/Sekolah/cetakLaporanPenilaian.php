	...
	<center>
		...
		<table width="625" border="1">
            ...
            <tr>
                ...
                <td style="text-align: center;"><?= $item['kedisiplinan']; ?></td>
                <td style="text-align: center;"><?= $item['tanggung_jawab']; ?></td>
                <td style="text-align: center;"><?= $item['kerja_sama']; ?></td>
                <td style="text-align: center;"><?= $item['kerajinan']; ?></td>
                <td style="text-align: center;"><?= $item['inisiatif']; ?></td>
            </tr>
            <?php } ?>
		</table>
		<br>
